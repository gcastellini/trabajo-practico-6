...
public class ArrivalsConstants {

    public static final String INPUT_SEARCH_XPATH = "xpath://input[@class='gLFyf gsfi']";
    public static final String SEARCH_BUTTON_NAME = "xpath://*[@id='menu-item-40']";
    public static final String STATS_ID = "xpath://*[@id='themify_builder_content-22']/div[2]/div/div/div/div/div[2]/div[%s]";
